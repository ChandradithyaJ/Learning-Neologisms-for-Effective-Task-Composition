...
# 🔁 CHANGED: initialize neologism to a semantically vacuous vector
with torch.no_grad():
    ...
    # If you want tiny noise, uncomment:
    # noise = 0.01 * torch.randn_like(vocab_mean)
    # init_vec = vocab_mean + noise
    init_vec = vocab_mean
